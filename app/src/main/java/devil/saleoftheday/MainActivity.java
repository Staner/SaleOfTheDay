                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if ( selectedCity.getShopCenters().get(which).getFloors().size() <= 1){
                                    floor.setEnabled(false);
                                    CreateSelectedShopCenter(which);
                                }
                            ...
                            private void CreateSelectedShopCenter(int which) {
                                ...
                                center.setText(selectedShopCenter.getName());
                            }
                        });
                builderSingle.show();
                ...
                builderSingle.setAdapter(floorsArrayAdapter,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                floor.setText(selectedFloor.getName());
